...
(function ($, scope, undefined) {
    ...
    NextendSmartSliderAdminSidebarSlides.prototype.initSlidesOrderable = function () {
        this.slidesContainer.sortable({
            ...
            helper: 'clone',
            placeholder: 'n2-box-sortable-placeholder n2-box n2-box-small',
            distance: 10
        });
    };
                ...
                zero: {
                    ...
                    fn: {
                        show: function () {
                            ...
                            new NextendElementAutocompleteSimple("sliderwidth", ["1920", "1200", "1000", "800", "600", "400"]);
...
(function ($, scope) {
    ...
    function sliders(groupID, ajaxUrl) {
        ...
        this.create = new NextendSmartSliderCreateSlider(ajaxUrl);
        this.initBulk();
    }
    ...
    sliders.prototype.initOrderable = function () {
        if (this.orderBy) {
            this.slidersContainer.sortable({
                ...
                helper: 'clone',
                placeholder: 'n2-box-sortable-placeholder n2-box',
                distance: 10
            });
        }
    };
    ...
    sliders.prototype.deleteSliders = function (ids, sliders) {
        this.hideMenu();
        var title = sliders[0].box.find('.n2-box-button a').text();
        if (sliders.length > 1) {
    ...
    sliders.prototype.initBulk = function () {
        ...
        actions.eq(0).on('click', $.proxy(function (e) {
            e.preventDefault();
            this.bulkAction('deleteSliders');
        }, this));

        //Duplicate
        actions.eq(1).on('click', $.proxy(function (e) {
            e.preventDefault();
            this.bulkAction('duplicateSliders');
        }, this));

        //Export
        actions.eq(2).on('click', $.proxy(function (e) {
            e.preventDefault();
            this.bulkAction('exportSliders');
        }, this));
    };
    ...
    sliders.prototype.bulkAction = function (action) {
        var slides = [],
            ids = [];
        this.bulkSelect(function (slider) {
            if (slider.selected) {
